...
!function ($) {
  ...
  * ========================= */
  ...
  function clearMenus() {
    $(toggle).each(function () {
      getParent($(this)).removeClass('openform')
    })
  }
  ...
  * ==================== */
  ...
  $(document)
    ...
    .on('click.dropdown.data-api','[data-toggle=dropdown]', clearDropdownOutOfForm)
    .on('click.dropdownform.data-api', '.apply, .cancel', clearMenus)
